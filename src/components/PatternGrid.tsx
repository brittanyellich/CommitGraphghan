...
import { Indicator } from '@radix-ui/themes/components/checkbox-group.primitive'
...
export const YARN_COLORS = (mode: string) => {
    switch(mode) {
        case 'light':
            return {
                0: { name: 'Cream', hex: '#f8f9fa', bg: 'bg-neutral-50', border: 'border-neutral-200', description: 'Background color for days with no commits', indicator: '0' },
                1: { name: 'Light Green', hex: '#c6e48b', bg: 'bg-green-100', border: 'border-green-200', description: '1-3 commits', indicator: '1' },
                2: { name: 'Medium Green', hex: '#7bc96f', bg: 'bg-green-300', border: 'border-green-400', description: '4-6 commits', indicator: '2' },
                3: { name: 'Dark Green', hex: '#239a3b', bg: 'bg-green-500', border: 'border-green-600', description: '7-9 commits', indicator: '3' },
                4: { name: 'Forest Green', hex: '#196127', bg: 'bg-green-700', border: 'border-green-800', description: '10+ commits', indicator: '4' },
                5: { name: 'Border', hex: '#e7e5e4', bg: 'bg-neutral-200', border: 'border-neutral-400', description: 'Border color', indicator: 'B' }
            }
        case 'dark':
            return {
                0: { name: 'Charcoal', hex: '#78716c', bg: 'bg-stone-500', border: 'border-stone-700', description: 'Background color for days with no commits', indicator: '0' },
                1: { name: 'Light Green', hex: '#c6e48b', bg: 'bg-green-100', border: 'border-green-200', description: '1-3 commits', indicator: '1' },
                2: { name: 'Medium Green', hex: '#7bc96f', bg: 'bg-green-300', border: 'border-green-400', description: '4-6 commits', indicator: '2' },
                3: { name: 'Dark Green', hex: '#239a3b', bg: 'bg-green-500', border: 'border-green-600', description: '7-9 commits', indicator: '3' },
                4: { name: 'Forest Green', hex: '#196127', bg: 'bg-green-700', border: 'border-green-800', description: '10+ commits', indicator: '4' },
                5: { name: 'Border', hex: '#292524', bg: 'bg-stone-800', border: 'border-stone-950', description: 'Border color', indicator: 'B' }
            }
        case 'spooky':
            return {
                0: { name: 'Charcoal', hex: '#78716c', bg: 'bg-stone-500', border: 'border-stone-700', description: 'Background color for days with no commits', indicator: '0' },
                1: { name: 'Light Orange', hex: '#c6e48b', bg: 'bg-orange-300', border: 'border-orange-400', description: '1-3 commits', indicator: '1' },
                2: { name: 'Medium Orange', hex: '#7bc96f', bg: 'bg-orange-400', border: 'border-orange-500', description: '4-6 commits', indicator: '2' },
                3: { name: 'Dark Orange', hex: '#239a3b', bg: 'bg-orange-500', border: 'border-orange-600', description: '7-9 commits', indicator: '3' },
                4: { name: 'Burnt Orange', hex: '#196127', bg: 'bg-orange-600', border: 'border-orange-700', description: '10+ commits', indicator: '4' },
                5: { name: 'Border', hex: '#292524', bg: 'bg-stone-800', border: 'border-stone-950', description: 'Border color', indicator: 'B' }
            }
        default:
            return {
...
export function generatePatternGrid(yearData: any, colors: any) {
    type GridSquare = {
    ...
    // Initialize grid with border squares
...
export function PatternGrid({ data, config }: PatternGridProps) {
  ...
  const patterns = useMemo(() => {
    return data.yearData.map(yearData => ({
      year: yearData.year,
      ...generatePatternGrid(yearData, colors)
    }))
  }, [data, config])
